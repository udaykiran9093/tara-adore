...
def download_invoice(sale_id):
    ...
    c.drawString(152*mm, height - 117*mm, "QTY")
    c.drawString(162*mm, height - 117*mm, "UNIT PRICE")
    c.drawRightString(width - 20*mm, height - 117*mm, "TOTAL")
    ...
    c.setFont("Helvetica", 9)
    c.setFillColorRGB(0.62, 0.60, 0.58)
    c.drawString(152*mm, height - 130*mm, str(sale['quantity']))
    c.drawString(162*mm, height - 130*mm, f"Rs.{float(sale['unit_price']):,.2f}")
    c.setFillColorRGB(0.91, 0.79, 0.48)
    c.setFont("Helvetica-Bold", 10)
    c.drawRightString(width - 20*mm, height - 130*mm, f"Rs.{float(sale['total_amount']):,.2f}")
    c.setFillColorRGB(0.91, 0.79, 0.48)
    c.setFont("Helvetica-Bold", 10)
